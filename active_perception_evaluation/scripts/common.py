...
class SearchPlan:
    def __init__(self, path):
        ...
        # probability mass of missed cells
        self.pMissed = np.zeros(len(self.gain))
        # probability mass of unexpected cells
        self.pUnexpected = np.zeros(len(self.gain))
        # time spent for NBV evaluation
        self.tNbv = np.zeros(len(self.gain))
        # time spent for LUT generation
        self.tLut = np.zeros(len(self.gain))
        # time spent planning
        self.tPlanning = np.zeros(len(self.gain))
        # time spent for all cpu operations
        self.tCpu = np.zeros(len(self.gain))
